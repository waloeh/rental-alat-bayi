<div  class="main-content">
	<section class="section">
		...
		<div class="card">
			<div class="card-body">
				<form action="<?php echo base_url('admin/DataCustomer/editCustomer/').$customer['id_customer']; ?>" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label>Nama Lengkap</label>
								<input type="text" name="nama" class="form-control" value="<?php echo $customer['nama_customer']; ?>">
						...
						<!-- 	<div class="form-group">
							...
							<div class="form-group">
								<label>Alamat</label>
								<input type="text" name="alamat" value="<?php echo $customer['alamat']; ?>" class="form-control">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="text" name="telepon" class="form-control" value="<?php echo $customer['no_tlp']; ?>">
								<?php echo form_error('telepon', '<small class="text-danger pl-3">', '</small>'); ?>
							</div>
							<div class="form-group">
								<label>No. KTP</label>
								<input type="text" name="ktp" class="form-control" value="<?php echo $customer['no_ktp']; ?>">
